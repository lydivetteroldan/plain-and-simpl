...
var config = {
  apiOrigins: {
    ...
    production: 'https://plain-and-simpl.herokuapp.com'
  }
};
...
var postEvents = __webpack_require__(17);
...
var onShowPosts = function onShowPosts(event) {
  event.preventDefault();
  api.index().then(ui.onShowPostsSuccess).catch(ui.onShowPostsFailure);
};
...
var onShowPost = function onShowPost(event) {
  ...
  var data = getFormFields(event.target);
  var post = data.post;
  api.show(post.id).then(ui.onShowPostSuccess).catch(ui.onShowPostFailure);
};
...
var onUpdatePost = function onUpdatePost(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.update(data).then(ui.onUpdatePostSuccess).catch(ui.onUpdatePostFailure);
};

var onDeletePost = function onDeletePost(event) {
  event.preventDefault();
  var id = event.target.dataset.id;
  api.destroy(id).then(ui.onDeletePostSuccess).catch(ui.onDeletePostFailure);
};
...
var createPostMessage = $('.create-post.section .message');
var findPostMessage = $('.find-post .message');
var editPostMessage = $('.edit-post .message');
var postsList = $('.posts.section');
var postsMessage = $('.posts.section .message');
var postSection = $('.post.section');
var showPostTemplate = __webpack_require__(20);
var showPostsTemplate = __webpack_require__(37);
...
var onShowPostsSuccess = function onShowPostsSuccess(data) {
...
var onShowPostsFailure = function onShowPostsFailure() {
...
var onShowPostFailure = function onShowPostFailure() {
...
var onUpdatePostFailure = function onUpdatePostFailure() {
...
var onDeletePostFailure = function onDeletePostFailure() {
  $(postsList).append('<p class="message">There was an error. Please try again. </p>');
};

module.exports = {
  onShowPostSuccess: onShowPostSuccess,
  onShowPostsSuccess: onShowPostsSuccess,
  onShowPostsFailure: onShowPostsFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"row\" data-id=\""
    ...
    + "\n    </div>\n  </div>\n  <div class=\"col-xs-12\">\n    <div class=\"text-muted post-footer\">\n      <div class=\"col-md-7\">\n        <small>Post ID: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.id : stack1), depth0))
    + "</small>\n      </div>\n      <div class=\"col-md-5\">\n        <button type=\"submit\" data-toggle=\"modal\" data-target=\"#editPostModal\" class=\"btn btn-default text-lowercase\" id=\"editPostButton\">Edit</button>\n        <button type=\"submit\" class=\"btn btn-default text-lowercase\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" id=\"deletePostButton\">Delete</button>\n      </div>\n    </div>\n  </div>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<ul class=\"list-unstyled posts-list\">\n"
